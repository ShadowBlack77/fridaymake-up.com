...
export const questionnaireActions = createActionGroup({
  ...
  events: {
    ...
    'Save Questionnaire': props<{ questionnaire: any }>(),
    'Save Questionnaire Successfully': props<{ questionnaire: any }>(),
    'Save Questionnaire Failure': props<{ errors: string }>(),
    'Update Questionnaire': props<{ questionnaire: any }>(),
    'Update Questionnaire Successfully': props<{ questionnaire: any }>(),
